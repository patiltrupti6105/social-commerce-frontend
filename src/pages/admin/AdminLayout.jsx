      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-border">
            ...
            <button
              onClick={logout}
              className="w-full mt-3 flex items-center justify-center gap-2 px-4 py-2 text-sm text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors"
            >
