...
export default function AdminDashboard() {
  ...
  try {
    ...
    setStats(statsRes.data.data);                              // unwrap ApiResponse
    setRecentActivity(activityRes.data.data?.activities || []);
  } catch (error) {
    // keep existing mock fallback as-is
    setStats({ totalUsers: 0, totalProducts: 0, totalOrders: 0,
                totalRevenue: 0, pendingApprovals: 0, reportedContent: 0 });
    setRecentActivity([]);
  } finally {
    setLoading(false);
  }
